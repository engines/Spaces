module Providers
  module Terraform
    class ArenaAspect < ::Spaces::Model
      ...
      # delegate(
      #   [:runtime_qualifier, :aspect_name_elements] => :arena
      # )

      # def runtime_artifact
      #   runtime_aspect.provider_snippets
      # end
      #
      ...
      #     terraform {
      #       required_providers {
      #         #{provider_division_aspects.flatten.map(&:required_snippet).flatten.compact.join}
      #       }
      #     }
      #   )
      # end
      ...
      # def runtime_aspect; provider_interface_for(runtime_qualifier) ;end
      #
      # def other_aspects
      #   other_identifiers.map { |i| provider_division_aspect_map[i] }
      # end
      #
      # def provider_interface_for(purpose); provider_division_aspect_map["#{purpose}"] ;end
      #
