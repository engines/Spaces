...
#       resolution: :pack,
#       [:snippets, :auxiliary_file_snippet_for, :file_copy_snippet_for] => :provider_division_aspect
#     )
#
...
#       packing_divisions.map { |d| d.snippets_for(precedence) if d.uses?(precedence) }
#     end
#
