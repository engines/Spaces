...
controllers.publishing.import(model: {repository: 'https://github.com/v2Blueprints/phpmyadmin'}, background: false)
# controllers.publishing.import(model: {repository: 'https://github.com/v2Blueprints/redmine'}, background: false)
# controllers.publishing.import(model: {repository: 'https://github.com/v2Blueprints/owncloud'}, background: false)
