...
controllers.arenas.create(model: {identifier: :cf})

# specify an image to build blueprints from
controllers.arenas.build_from(identifier: :cf, image_identifier: :'python:3.8-slim-buster')
# controllers.arenas.build_from(identifier: :cf, image_identifier: :base_python)
...
controllers.arenas.provide(identifier: :cf, role_identifier: :packing, provider_identifier: :docker, compute_identifier: :'us-east-1')
controllers.arenas.provide(identifier: :cf, role_identifier: :orchestration, provider_identifier: :cloud_formation, compute_identifier: :'ap-southeast-2')
controllers.arenas.provide(identifier: :cf, role_identifier: :runtime, provider_identifier: :docker)

# bind blueprints to the arena
controllers.arenas.bind(identifier: :cf, blueprint_identifier: 'managed-functions')
controllers.arenas.bind(identifier: :cf, blueprint_identifier: 'startup-infrastructure')

# ------------------------------------------------------------------------------
# stage some blueprints in the mf_infrastructure arena
controllers.arenas.stage(identifier: :cf)

# # build images for the arena
# controllers.arenas.build(identifier: :cf, verbose: true)
#
# # bring up containers for arena
# controllers.arenas.apply(identifier: :cf, verbose: true)
